...
public class Matiere {
	...
	public List<MatiereParFormation> getMatieresParFormations() {
		return matieresParFormations;
	}

	public void setMatieresParFormations(List<MatiereParFormation> matieresParFormations) {
		this.matieresParFormations = matieresParFormations;
	}
